        ...
        <div class="card">
            <div class="card-body">
                ...
                <ul class="list-group list-group-flush">
                    ...
                    <?php }?>
                    <li class="list-group-item bg-info text-white"><i class="fa fa-check"></i> Suport 4 K</li>
                ...
                <hr/>
                <center>
                    <a href="booking.php?id=<?php echo $hasil['id_mobil'];?>" class="btn btn-success">Peminjam</a>
